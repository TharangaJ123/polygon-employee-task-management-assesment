    ...
    <View className="flex-1 bg-polygon-bg p-6 pt-12">
      <View className="flex-row justify-between items-center mb-8">
        <View>
          ...
          <Text className="text-sm text-gray-500 mt-1">Welcome back, {user?.name || 'Admin'}</Text>
        </View>
      ...
      <View className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mt-4">
        <Text className="text-lg font-semibold text-gray-800 mb-2">Admin Features</Text>
        <Text className="text-gray-600 leading-6">
          This is the administrative view. Here you will be able to manage employees, assign tasks, and view reports.
        </Text>
      </View>
    </View>
  );
